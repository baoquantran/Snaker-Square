                   ...
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                    <tr>
                     <td valign="top" class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-26" align="left" style="mso-line-height: exactly;line-height: 156%;letter-spacing: -0.2px;font-family: Arial, Helvetica;font-size: 18px;font-weight: normal;color: #ffffff;text-align: left;text-align-last: left;">
                      ...
                      <div><span style="font-size: 14px;color: rgb(29, 29, 30);font-weight: bold; text-transform: uppercase;">Lưu ý: Tài khoản của bạn đang được thay đổi mật khẩu</span>
                      </div>
                      ...
                      <div><span style="font-size: 14px;color: rgb(29, 29, 30);">Nếu Bạn đang thực hiện thay đổi mật khẩu, vui lòng xác nhận vào nút dưới đây. </span>
                      </div>
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                        <td align="center">
                        <table class="pc-width-hug pc-w620-collapsed-0" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            ...
                            <tr>
                                ...
                                <td align="center" valign="top">
                                    ...
                                    <a href="{{route('user.change_pass',$user->remember_token)}}" style="margin-top: 30px; margin-bottom: 30px; border-radius: 8px;background-color: #1595e7;padding: 15px 17px 15px 17px;font-family: Arial, Helvetica;font-weight: 500;font-size: 16px;line-height: 150%;letter-spacing: -0.2px;color: #ffffff;display: inline-block;vertical-align: top;text-align: center;text-decoration: none;white-space: nowrap;-webkit-text-size-adjust: none;" target="_blank"><span><span style="white-space: pre-wrap;">Xác nhận thay đổi mật khẩu</span></span></a>
                                    </th>
                                    </tr>
                                    </table>
                                </td>
