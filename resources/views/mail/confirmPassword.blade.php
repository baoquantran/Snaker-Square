          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
           <tr>
            <td style="padding: 0px 0px 0px 0px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
              <tr>
               <td valign="top" class="pc-w520-padding-25-25-25-25 pc-w620-padding-30-30-30-30" style="padding: 36px 40px 0 40px;border-radius: 0px;background-color: #ffffff;" bgcolor="#ffffff">
                         ...
                         <table align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                           <td align="left" valign="top">
                            <table align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                             <tr>
                              <td class="pc-lg-hide pc-sm-show" valign="top">
                                ...
                                <tr>
                                 <td valign="top" align="left">
                                  <div class="pc-font-alt" style="text-align: left;text-align-last: left;">
                                   <img src="images/6cc1d1618ef6df5cefd525a00eee5859.png" class="" width="15" height="14" style="display: block;border: 0;outline: 0;line-height: 100%;-ms-interpolation-mode: bicubic;width:15px;height: auto;max-width: 100%;" alt="" />
                                  </div>
                                 </td>
                                </tr>
                               </table>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
           <tr>
            <td style="padding: 0px 0px 0px 0px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
              <tr>
               <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 40px 40px 0 40px;border-radius: 0px;background-color: #ffffff;" bgcolor="#ffffff">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                  <td align="left" valign="top" style="padding: 0px 0px 17px 0px;">
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                    <tr>
                     <td valign="top" class="pc-font-alt" align="left" style="mso-line-height: exactly;line-height: 121%;font-family: Arial, Helvetica;font-size: 14px;color: #40be65;text-align: left;text-align-last: left;">
                      <div><span style="color: rgb(29, 29, 30);line-height: 100%;">Xin chào </span><span style="font-weight: 700;font-style: normal;color: rgb(29, 29, 30);line-height: 100%;">{{ $user->name }}</span><span style="color: rgb(29, 29, 30);line-height: 100%;">,</span>
                      </div>
                      <div><span style="color: rgb(29, 29, 30);">﻿</span>
                      </div>
                      <div><span style="color: rgb(29, 29, 30);">Chúng tôi nhận được yêu cầu khôi phục lại mật khẩu của bạn vào lúc <span style="font-weight: bold;">{{$mailDate->format('H:i:s d/m/Y')}}</span> từ địa chỉ email mà bạn đã đăng ký trên hệ thống của </span><span style="font-weight: bold; font-style: normal;color: rgb(29, 29, 30);">Sneaker Square</span><span style="color: rgb(29, 29, 30);">.</span>
                      </div>
                      <div><span>﻿</span>
                      </div>
                      <div><span style="color: rgb(29, 29, 30);">Để khôi phục lại mật khẩu, xin vui lòng ấn vào link phía dưới:</span>
                      </div>
                     </td>
                    </tr>
                   </table>
                           ...
                           <td align="center" valign="top">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation">
                             <tr>
                              ...
                              <a href="{{ route('user.reset_pass', $user->remember_token) }}" style="border-radius: 8px;background-color: #1595e7;padding: 15px 17px 15px 17px;font-family: Arial, Helvetica;font-weight: 500;font-size: 16px;line-height: 150%;letter-spacing: -0.2px;color: #ffffff;display: inline-block;vertical-align: top;text-align: center;text-decoration: none;white-space: nowrap;-webkit-text-size-adjust: none;" target="_blank"><span><span style="white-space: pre-wrap;">Khôi phục mật khẩu tại đây</span></span></a>
                              </th>
                             </tr>
                            </table>
                           </td>
                   ...
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                    <tr>
                     <td valign="top" class="pc-font-alt" align="left" style="mso-line-height: exactly;line-height: 156%;letter-spacing: -0.2px;font-family: Arial, Helvetica;font-size: 14px;font-weight: normal;color: #9b9b9b;text-align: left;text-align-last: left;">
                      <div style="text-align: start; text-align-last: start;"><span style="font-weight: 400;font-style: normal;color: rgb(55, 65, 81);">Sau khi nhấn vào đường dẫn trên, bạn sẽ được dẫn đến một trang web để đặt lại mật khẩu. </span><span style="color: rgb(29, 29, 30);">Nếu bạn không yêu cầu việc này, vui lòng bỏ qua email này hoặc liên hệ với chúng tôi qua email </span><a href="mailto:cskh@6flames.id.vn" target="_blank" style="text-decoration: none; color: #9b9b9b; line-height: 1; font-style: italic;"><span style="text-decoration: underline;color: #4444f2;">cskh@6flames.id.vn</span></a><span style="color: rgb(29, 29, 30);"> hoặc thông tin ở phía dưới.</span><span>﻿</span>
                      </div>
                      <div><span>﻿</span>
                      </div>
