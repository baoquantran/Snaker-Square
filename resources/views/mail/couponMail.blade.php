          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
           <tr>
            <td style="padding: 0px 0px 0px 0px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
              <tr>
               <td valign="top" class="pc-w520-padding-25-25-25-25 pc-w620-padding-30-30-30-30" style="padding: 36px 40px 36px 40px;border-radius: 0px;background-color: #ffffff;" bgcolor="#ffffff">
                         ...
                         <table align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                           <td align="left" valign="top">
                            <table align="left" border="0" cellpadding="0" cellspacing="0" role="presentation">
                             <tr>
                              <td class="pc-lg-hide" valign="top">
                                ...
                                <tr>
                                 <td valign="top" align="left">
                                  <div class="pc-font-alt" style="text-align: left;text-align-last: left;">
                                   <img src="" class="" width="15" height="14" style="display: block;border: 0;outline: 0;line-height: 100%;-ms-interpolation-mode: bicubic;width:15px;height: auto;max-width: 100%;" alt="" />
                                  </div>
                                 </td>
                                </tr>
                               </table>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                  <td align="left" valign="top" style="padding: 0px 0px 0px 0px;">
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                    <tr>
                     <td valign="top" class="pc-font-alt" align="left" style="mso-line-height: exactly;line-height: 121%;font-family: Arial, Helvetica;font-size: 14px;font-weight: 500;color: #40be65;text-align: left;text-align-last: left;">
                      <div><span style="color: rgb(29, 29, 30);line-height: 100%;">Chào bạn,</span>
                      </div>
                      <div><span>&#xFEFF;</span>
                      </div>
                      <div><span style="color: rgb(29, 29, 30);line-height: 100%;">Nhằm tri ơn khách hàng đã luôn đồng hành và ủng hộ </span><span style="font-weight: 700;font-style: normal;color: rgb(29, 29, 30);line-height: 100%;">Sneaker Square</span><span style="color: rgb(29, 29, 30);line-height: 100%;"> trong thời gian vừa qua.</span>
                      </div>
                      <div><span style="color: rgb(29, 29, 30);">﻿</span>
                      </div>
                      <div><span style="color: rgb(29, 29, 30);">Chúng tôi trân trọng gửi tặng bạn mã giảm giá khi bạn mua sắm tại hệ thống của chúng tôi.</span>
                      </div>
                      <div><span>﻿</span>
                      </div>
                      <div><span>﻿</span>
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation">
                             <tr>
                              <th valign="top" align="center" style="padding: 0px 0px 0px 0px;font-weight: normal;line-height: 1;">
                               <a style="border-radius: 8px;background-color: #FD7E14;padding: 15px 17px 15px 17px;font-family: Arial, Helvetica;font-weight: 500;font-size: 16px;line-height: 150%;letter-spacing: -0.2px;color: #ffffff;display: inline-block;vertical-align: top;text-align: center;text-decoration: none;white-space: nowrap;-webkit-text-size-adjust: none;" target="_blank">Mã giảm: <span style="font-weight: bold;">{{ $cou->coupon_code }}</span></a>
                              </th>
                             </tr>
                            </table>
                           </td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
           <tr>
            <td style="padding: 0px 0px 0px 0px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
              <tr>
               <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 0 40px 40px 40px;border-radius: 0px;background-color: #ffffff;" bgcolor="#ffffff">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                   ...
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                    <tr>
                     <td valign="top" class="pc-font-alt" align="left" style="mso-line-height: exactly;line-height: 156%;letter-spacing: -0.2px;font-family: Arial, Helvetica;font-size: 14px;font-weight: normal;color: #9b9b9b;text-align: left;text-align-last: left;">
                        <div style="text-align: start; text-align-last: start;"><span style="color: rgb(29, 29, 30);">Hãy áp dụng mã giảm giá này khi thanh toán để nhận ngay ưu đãi hấp dẫn: </span><span style="font-weight: 700;font-style: normal;color: rgb(29, 29, 30);">Giảm {{($cou->coupon_condition == 0) ? $cou->coupon_value.'%' : number_format($cou->coupon_value,0,",",".").'đ' }}</span><span style="color: rgb(29, 29, 30);"> cho các đơn hàng thanh toán tại trang web của chúng tôi. </span>
                        </div>
                        <div style="text-align: start; text-align-last: start;"><span>&#xFEFF;</span>
                        </div>
                        <div style="text-align: start; text-align-last: start;"><span style="color: rgb(29, 29, 30);">Mã giảm giá áp dụng từ ngày </span><span style="font-weight: 700;font-style: normal;color: rgb(29, 29, 30);">{{ date('d-m-Y', strtotime($cou->coupon_start))}}</span><span style="color: rgb(29, 29, 30);"> đến hết ngày </span><span style="font-weight: 700;font-style: normal;color: rgb(29, 29, 30);">{{ date('d-m-Y', strtotime($cou->coupon_end))}}. </span><span style="font-weight: 400;font-style: normal;color: rgb(29, 29, 30);">Đừng để lỡ cơ hội nhận ưu đãi này!</span>
                      </div>
                      <div style="text-align: start; text-align-last: start;"><span>&#xFEFF;</span>
                      </div>
                      <div style="text-align: start; text-align-last: start;"><span style="font-weight: 400;font-style: normal;color: rgb(29, 29, 30);">Cảm ơn bạn đã tin tưởng và luôn ủng hộ </span><span style="font-weight: 700;font-style: normal;color: rgb(29, 29, 30);">Sneaker Square</span><span style="font-weight: 400;font-style: normal;color: rgb(29, 29, 30);"> trong suốt thời gian vừa qua.</span>
                      </div>
                      <div><span>﻿</span>
                      </div>
                      <div><span style="color: rgb(29, 29, 30);">Trân trọng,</span>
                      </div>
                      <div><span style="font-weight: 700;font-style: normal;color: rgb(29, 29, 30);">Đội ngũ Sneaker Square</span>
                      </div>
                     </td>
                    </tr>
                   </table>
                             ...
                             <tr>
                              <td valign="top" align="left">
                               <div class="pc-font-alt" style="line-height: 143%;font-family: Arial, Helvetica;font-size: 14px;font-weight: 500;color: #1595e7;text-align: left;text-align-last: left;">
                                <div><span style="font-weight: 700;font-style: normal;color: rgb(255, 255, 255);">Website:</span><span> </span><a href="{{env('APP_URL')}}" style="text-decoration: none; color: #1595e7; line-height: 1;"><span style="text-decoration: underline;color: rgb(255, 255, 255);">6flames.id.vn</span></a><span>﻿</span>
                                </div>
