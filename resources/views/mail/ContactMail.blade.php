                   ...
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" align="left">
                    <tr>
                     <td valign="top" class="pc-font-alt pc-w620-fontSize-16 pc-w620-lineHeight-26" align="left" style="mso-line-height: exactly;line-height: 156%;letter-spacing: -0.2px;font-family: Arial, Helvetica;font-size: 18px;font-weight: normal;color: #ffffff;text-align: left;text-align-last: left;">
                      <div><span style="font-size: 14px;color: rgb(29, 29, 30);line-height: 100%;">Chào </span><span style="font-size: 14px;font-weight: 700;font-style: normal;color: rgb(29, 29, 30);line-height: 100%;">{{$contact->name}}</span><span style="font-size: 14px;color: rgb(29, 29, 30);line-height: 100%;">,</span>
                      </div>
                      <div><span style="color: rgb(29, 29, 30);">﻿</span>
                      </div>
                      <div><span style="font-size: 14px;color: rgb(29, 29, 30);">Chúng tôi đã nhận được thông tin của bạn trên hệ thống </span><span style="font-size: 14px;font-weight: 700;font-style: normal;color: rgb(29, 29, 30);">Sneaker Square</span><span style="font-size: 14px;color: rgb(29, 29, 30);"> của chúng tôi.</span>
                      </div>    
                      <div><span style="font-size: 14px;color: rgb(29, 29, 30);">Chúng tôi sẽ sớm liên lạc với bạn qua Email này sớm nhất. </span>
                      </div>      
